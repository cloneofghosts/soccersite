...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    autoslug.fields.AutoSlugField(
                        editable=False, populate_from="league_name", unique=True
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("SCH", "Scheduled"),
                            ("FIN", "Final"),
                            ("FET", "Final/Extra Time"),
                            ("FPK", "Final/Penalty Kicks"),
                            ("CAN", "Cancelled"),
                            ("RES", "Rescheduled"),
                        ],
                        default="SCH",
                ...
                (
                    "slug",
                    autoslug.fields.AutoSlugField(
                        editable=False, populate_from="__str__", unique=True
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="league",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="lastever.league"
            ),
        ),
        migrations.AddField(
            model_name="schedule",
        ...
        migrations.AddField(
            ...
            name="team",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="lastever.team"
            ),
        ),
        migrations.AddField(
            model_name="division",
